...
import { Play, Calendar, Clock, Users, Radio, Download, Share2 } from 'lucide-react';
...
export function MediaPage() {
  ...
  const videoLibrary = [
    ...
    },
    {
      ...
      date: 'April 10, 2024',
      duration: '12 min',
      thumbnail: 'https://images.unsplash.com/photo-1544537150-6e4b998de2df?w=400&h=225&fit=crop',
      views: 456,
      category: 'Events'
    },
    {
  ...
  const categories = ['All', 'Educational', 'Events', 'Youth', 'Historical', 'Support'];

  const podcasts = [
    {
      id: 1,
      title: 'Islamic Wisdom Weekly',
      description: 'Weekly discussions on Islamic teachings and their application in daily life',
      episodes: 24,
      subscribers: '1.2K'
    },
    {
    ...
    <div className="min-h-screen bg-white/95 backdrop-blur-sm relative">
      ...
      <section className="py-24 bg-gradient-to-br from-purple-700 via-blue-600 to-green-600 text-white relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-2xl mx-auto">
            Watch our live streams, educational content, and community events. Stay connected with Islamic learning and community activities.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {liveStreams.map((stream) => (
              <Card key={stream.id} className="hover:shadow-lg transition-shadow border-2 border-red-200">
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg">
                    <p className="text-blue-800 font-medium">Next Stream: {stream.nextStream}</p>
                  </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Podcasts</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Subscribe to get notified about new videos, live streams, and educational content.
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Streaming Information</h2>
