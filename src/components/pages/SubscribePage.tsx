  ...
  const subscriptionTypes = [
    {
      ...
      description: 'Stay updated with community news, events, and Islamic reminders',
      frequency: 'Weekly',
      color: 'bg-blue-500'
    },
    {
      ...
      description: 'Get notified about upcoming programs, lectures, and community gatherings',
      frequency: 'As needed',
      color: 'bg-green-500'
    },
    {
      ...
      description: 'Updates on Quran classes, Islamic studies, and youth programs',
      frequency: 'Monthly',
      color: 'bg-purple-500'
    },
    {
      ...
      description: 'Progress reports and donation opportunities for our new mosque',
      frequency: 'Monthly',
      color: 'bg-orange-500'
    }
  ];
      ...
      <section className="py-24 bg-gradient-to-br from-green-700 via-green-600 to-green-800 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed font-light">
            Subscribe to receive updates about our community, events, programs, and the journey of building our new mosque
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Select the types of updates you'd like to receive from our community
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {subscriptionTypes.map((type) => (
              <Card key={type.id} className="hover:shadow-lg transition-all duration-300 hover:scale-105 border-0 cursor-pointer group">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {subscriptionTypes.map((type) => (
                      <div key={type.id} className="flex items-start space-x-3 p-4 bg-gray-50 rounded-lg">
                        <Checkbox id={type.id} className="mt-1" />
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-sm text-blue-800">
                      ...
                      <p>
                        We respect your privacy. Your information will only be used to send you the updates you've requested. 
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <label htmlFor="terms" className="text-sm text-gray-600 cursor-pointer">
                    I agree to receive communications from NWMIS and understand that I can unsubscribe at any time.
                  </label>
                </div>

                <Button 
                  size="lg" 
                  className="w-full bg-green-600 hover:bg-green-700 h-14 text-lg font-medium rounded-full transition-all duration-300 hover:scale-105"
                >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-medium text-gray-900 mb-2">Never Miss Events</h3>
              <p className="text-gray-600 text-sm">
                Be the first to know about prayers, lectures, community gatherings, and special celebrations
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Receive Islamic reminders, educational content, and information about our learning programs
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Be part of our growing community and stay updated on our mosque development progress
              </p>
            </div>
          </div>
        </div>
