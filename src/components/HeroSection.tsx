			...
			<div className="absolute inset-0 opacity-5">
				...
				<div className="absolute bottom-20 right-20">
					<svg
						...
						className="text-white"
					>
						<path d="M30 5 Q35 20 30 25 Q25 20 30 5" fill="currentColor" />
				...
				<div className="absolute top-40 right-1/4">
					<svg
						...
						className="text-white"
					>
						<path d="M50 10 L55 40 L50 45 L45 40 Z" fill="currentColor" />
						<circle
							cx="50"
							cy="25"
							r="8"
			...
			<div className="relative max-w-7xl mx-auto px-6 py-20 w-full">
				<div className="max-w-5xl mx-auto text-center">
					...
					<p className="text-xl md:text-2xl mb-16 max-w-4xl mx-auto leading-relaxed font-light text-green-50/90">
						New Westminster Islamic Society — Building a vibrant Muslim
						community through faith, knowledge, and service in the heart of
						Vancouver
					</p>
					...
					<div className="grid md:grid-cols-3 gap-6 mb-16 max-w-4xl mx-auto">
						<div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
							...
							<div className="text-green-100 font-medium mb-1">Location</div>
							<div className="text-green-200 text-sm">8879 Selkirk Street</div>
							<div className="text-green-200 text-sm">Vancouver, BC</div>
						</div>
						<div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
							<Users className="h-8 w-8 text-green-200 mx-auto mb-3" />
							<div className="text-green-100 font-medium mb-1">Community</div>
							<div className="text-green-200 text-sm">200+ Members</div>
							<div className="text-green-200 text-sm">All Welcome</div>
						</div>
						<div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
							...
							<div className="text-green-200 text-sm">Friday 1:00 PM</div>
							<div className="text-green-200 text-sm">Join Us</div>
						</div>
					</div>
					...
					<div className="flex flex-col sm:flex-row gap-6 justify-center max-w-lg mx-auto">
						...
						<Button
							...
							variant="outline"
							className="border-2 border-white text-white bg-green-800 hover:bg-white hover:text-green-800 px-10 py-4 h-14 text-lg font-medium rounded-full transition-all duration-300 hover:scale-105"
						>
